                ...
                for date_folder in date_folders:
                    ...
                    for passport_folder in passport_folders:
                        ...
                        for permit_pdf in permit_pdfs:
                            # Construct relative path within the ZIP for reporting
                            relative_path = Path(zip_path.name) / date_folder.name / passport_folder.name / permit_pdf.name
                            result = self.process_single_pdf(permit_pdf, has_multiple_files)
                            result['File Name'] = str(relative_path)  # Overwrite with original-like path
